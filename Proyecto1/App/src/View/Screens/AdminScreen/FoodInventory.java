...
public class FoodInventory extends VBox {
    ...
    public VBox topCenterBorder() {
        ...
        foodList.addElem(new Node[]{new Text("Hamburguesa"), new Text("Comida")});
        foodList.addElem(new Node[]{new Text("Hamburguesa"), new Text("Comida")});
        foodList.addElem(new Node[]{new Text("Hamburguesa"), new Text("Comida")});
        ...
        topCenter.getChildren().addAll(filterGrid, foodList);
    ...
    public void addInfo(GridPane infoGrid, String name, String type, String availability, String isService,
            String price) {
